...
class GTSDB_dataset(object):
    def __init__(self, img_path, gt_path, class_amount):
    ...
    def _read_gt(self):
        width = 1360
        height = 800
        img_list = np.genfromtxt(self.gt_path, delimiter=';', dtype=None, encoding=None)
        dic = {}
        for i in img_list:
            image_name = i[0]
            target = [i[1] / width, i[2] / height, i[3] / width, i[4] / height, self._to_one_hot(i[5])]  # x_min, y_min, x_max, y_max, class
    ...
    def _to_one_hot(self, name):
        one_hot_vector = [0] * self.class_amount
